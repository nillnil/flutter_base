...
/// modify from https://github.com/flutter/flutter/blob/master/packages/flutter/lib/src/material/bottom_navigation_bar.dart
/// lastest commit: 2020.02.11
/// https://github.com/flutter/flutter/commit/9fb781a54a587c696839775a6d2e878860d0bbf7
/// #50377 https://github.com/flutter/flutter/pull/50377
/// flutter v1.17.2
///
...
class _BottomNavigationTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (item.icon == null && item.title != null && showIndicator) {
      children.add(
        Container(
